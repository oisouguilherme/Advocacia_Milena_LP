  ...
  return (
    <div>
      <div className="bg-white/90">
        <div className="max-w-6xl mx-auto pt-32 px-4 pb-44 grid md:grid-cols-2 items-center text-cinza">
          <div className="space-y-8" data-aos="fade-right">
            <h2 className="text-xl text-azul sm:text-3xl font-bold">
            ...
            <p className="sm:w-[90%] italic">
              ...
              sociedade, porque esta resistência não pode ser com o triunfo,
              senão quando for geral.” <br /> Rudolfh Von Ihering.
            </p>
